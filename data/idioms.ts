...
export const IDIOM_GROUPS: IdiomGroup[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "One's ears are burning", meaning: "To sense that people are talking about you behind your back.", pic: "👂🔥", story: "The Romans believed the body reacted when it was being discussed — a burning right ear meant praise, the left meant slander. Pliny the Elder wrote it down and the superstition outlived the empire." },
      ...
      { phrase: "Walls have ears", meaning: "Be careful what you say — someone may be listening.", pic: "🧱👂", story: "Catherine de' Medici is said to have had listening tubes built into the walls of the Louvre so she could hear plots against her family. The warning stuck." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "Meet one's Waterloo", meaning: "To suffer a final, crushing defeat you cannot come back from.", pic: "⚔️🏳️", story: "At Waterloo in 1815 Napoleon lost his last battle, his army and his empire in a single day. It finished him — which is why this defeat is the one with no comeback." },
      ...
      { phrase: "Hit below the belt", meaning: "To act unfairly, especially in a contest or argument.", pic: "🥊⬇️", story: "Boxing's Queensberry Rules made punches below the waistband illegal. Bringing someone's family into an argument is the verbal version." },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Have the Midas touch", meaning: "The ability to make a success of everything you take on.", pic: "👆✨", story: "King Midas of Greek myth wished that everything he touched would turn to gold. It ruined him — his food and his daughter turned to metal — but the phrase kept only the golden half." },
      ...
      { phrase: "Yeoman's service", meaning: "Excellent, loyal and valuable work.", pic: "🛡️🎯", story: "English yeomen were free farmers who formed the longbow companies — not nobles, but their steady service won Agincourt. Praise for solid, dependable work.", hardWords: [{ word: "yeoman", meaning: "a free farmer of old England who also served as a soldier" }] },
      ...
      { phrase: "Go the extra mile", meaning: "To make more effort than is required of you.", pic: "🏃➕", story: "Roman soldiers could legally force a civilian to carry their pack for one mile. The Sermon on the Mount answered: carry it two. The second mile is the one nobody made you walk." },
      { phrase: "Leave no stone unturned", meaning: "To make every possible effort to find or achieve something.", pic: "🪨🔎", story: "A defeated Persian general was rumoured to have buried treasure. The Oracle at Delphi told the searcher to turn every stone — he did, and found it." },
      ...
      { phrase: "A Herculean task", meaning: "A job needing enormous strength or effort.", pic: "💪🏛️", story: "Hercules was set twelve labours so hard they were meant to be impossible — killing the Hydra, cleaning thirty years of filth from the Augean stables in one day. Any of them is the benchmark." },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Rise like a rocket, fall like a stick", meaning: "To succeed very rapidly and then decline just as quickly.", pic: "🚀🪵", story: "Edmund Burke's jab at a rival politician. A firework rocket climbs spectacularly, burns out, and the bare stick drops straight back down." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "A Trojan horse", meaning: "Something that appears harmless but is meant to destroy from within.", pic: "🐴🏛️", story: "The Greeks left a giant wooden horse outside Troy as a parting gift. Soldiers were hidden inside; the Trojans wheeled it through their own gates and lost the city that night." },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "A wolf in sheep's clothing", meaning: "A dangerous person who appears harmless and innocent.", pic: "🐺🐑", story: "From Aesop: a wolf pulled a fleece over himself to walk unnoticed among the flock. The danger is not that he looks dangerous — it is that he does not." },
      ...
      { phrase: "A red herring", meaning: "A clue or topic that distracts attention from the real issue.", pic: "🐟🚩", story: "Smoking a herring turns it red and gives it an overpowering smell. The journalist William Cobbett wrote in 1807 that he had once used one to pull hounds off a trail — he meant it as a jab at the press, and the phrase took its modern meaning from his story." },
      ...
      { phrase: "A snake in the grass", meaning: "A treacherous person who pretends to be a friend.", pic: "🐍🌿", story: "Virgil's warning — 'a snake lurks in the grass'. The danger is invisible until you have already stepped." },
      { phrase: "Cry wolf", meaning: "To raise a false alarm repeatedly so people stop believing you.", pic: "🐺📢", story: "Aesop's shepherd boy shouted 'wolf!' for fun twice; the village came running twice. The third time the wolf was real and nobody moved." },
      { phrase: "A Judas kiss", meaning: "An act of betrayal disguised as friendship and affection.", pic: "💋🗡️", story: "Judas identified Jesus to the soldiers by greeting him with a kiss. The most affectionate gesture available, used as a signal to arrest." },
      { phrase: "Thirty pieces of silver", meaning: "Money accepted for betraying someone's trust.", pic: "🪙🤝", story: "The exact price Judas was paid. Ever since, the phrase names the payment rather than the crime — the sum that bought a betrayal." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "An albatross around one's neck", meaning: "A heavy burden causing constant trouble and guilt.", pic: "🪶⛓️", story: "In Coleridge's Ancient Mariner, a sailor shoots the albatross that had guided his ship. His crew hangs the dead bird around his neck so he must wear his guilt where everyone can see it." },
      ...
      { phrase: "A monkey on one's back", meaning: "A persistent problem or addiction that will not leave.", pic: "🐒🎒", story: "Like Sinbad's Old Man of the Sea, who climbed on his shoulders and refused to get off. The weight is bad; the not-letting-go is worse." },
      { phrase: "Carry the weight of the world on one's shoulders", meaning: "To be burdened with many worries and responsibilities.", pic: "🌍🏋️", story: "Atlas was condemned to hold up the heavens forever. Anyone who looks permanently exhausted by everyone else's problems is doing his job." },
      { phrase: "The sword of Damocles", meaning: "A constant threat of imminent danger.", pic: "🗡️👑", story: "Damocles envied the king's luxury, so the king let him sit on the throne — under a sword hung by a single horse hair. That is what power feels like from the inside.", hardWords: [{ word: "imminent", meaning: "about to happen at any moment" }] },
      { phrase: "A white elephant", meaning: "A costly possession that is useless and hard to maintain.", pic: "🐘🤍", story: "White elephants really were sacred in Siam — they could not be worked, and feeding one was ruinous. The tale that kings gifted them to punish courtiers seems to be a European invention of the 1800s, but the expense was genuine enough for the phrase to stick." },
      { phrase: "Hang by a thread", meaning: "To be in a very uncertain and dangerous situation.", pic: "🧵😰", story: "The same horse hair that held Damocles' sword. Everything is fine, right up until the thread is not." },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Between Scylla and Charybdis", meaning: "Caught between two equally dangerous choices.", pic: "🐍🌀", story: "In the Odyssey, Odysseus had to steer a narrow strait with a six-headed monster on one cliff and a ship-swallowing whirlpool on the other. He chose to lose six men rather than the whole ship." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "Cross the Rubicon", meaning: "To take an irreversible step with serious consequences.", pic: "🌊⚔️", story: "In 49 BC Caesar led his army across the Rubicon river into Italy, which by law meant war with Rome. He is said to have declared the die was cast — there was no marching back." },
      { phrase: "The die is cast", meaning: "An irrevocable decision has been made.", pic: "🎲✔️", story: "Caesar's own words at the Rubicon. Once the dice leave your hand, no amount of wishing changes the number.", hardWords: [{ word: "die", meaning: "one dice (the singular of dice)" }, { word: "irrevocable", meaning: "impossible to change or cancel" }] },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "A Pyrrhic victory", meaning: "A victory won at such a cost that it is not worth it.", pic: "🏆💀", story: "King Pyrrhus beat the Romans twice and lost most of his army doing it. He is supposed to have said one more such victory would ruin him completely." },
      ...
      { phrase: "Hoist by one's own petard", meaning: "To be harmed by the very trap one set for others.", pic: "💣🙃", story: "A petard was a small bomb used to blast open gates. Engineers who lit them were regularly blown into the air by their own device — Shakespeare's Hamlet made it a phrase.", hardWords: [{ word: "petard", meaning: "a small bomb used to blow open a door or gate" }, { word: "hoist", meaning: "lifted up (here, by an explosion)" }] },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Hold out an olive branch", meaning: "To offer peace and reconciliation after a conflict.", pic: "🕊️🌿", story: "The dove returned to Noah's ark with an olive leaf, proof the flood was ending. Greeks and Romans carried olive branches to show they came unarmed.", hardWords: [{ word: "reconciliation", meaning: "becoming friendly again after a quarrel" }] },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Bob's your uncle", meaning: "And there it is — it will be that easy.", pic: "👨🎩", story: "British PM Robert 'Bob' Cecil handed his nephew a plum government post he had not earned. Everyone understood how the job was got, and the phrase came to mean 'and just like that, done'." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Blow hot and cold", meaning: "To be inconsistent, changing one's attitude repeatedly.", pic: "🥵🥶", story: "In Aesop, a traveller blows on his hands to warm them, then on his soup to cool it. His host throws him out — anyone who blows both hot and cold cannot be trusted." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Throw pearls before swine", meaning: "To offer something valuable to those who cannot appreciate it.", pic: "🫧🐖", story: "From the Sermon on the Mount. The pig is not insulted and not impressed — it simply has no way of knowing what a pearl is." },
      ...
      { phrase: "Tilt at windmills", meaning: "To fight imaginary enemies and pursue unrealistic causes.", pic: "🌬️🗡️", story: "Don Quixote read so many books about knights that he charged a row of windmills, convinced they were giants. The enemy was entirely in the reading.", hardWords: [{ word: "tilt", meaning: "to charge at an opponent with a lance" }] },
      { phrase: "Penelope's web", meaning: "A task deliberately never finished, causing endless delay.", pic: "🧵♾️", story: "Penelope told her suitors she would remarry once her weaving was done — then quietly unpicked every night's work each evening. The cloth was never finished, and neither was the wait." },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "Achilles' heel", meaning: "A single fatal weakness in someone otherwise strong.", pic: "🦶🏹", story: "Achilles' mother dipped him in the river Styx to make him invulnerable, holding him by the heel — so the heel stayed dry, and unprotected. Years later an arrow found it.", hardWords: [{ word: "invulnerable", meaning: "impossible to harm" }] },
      { phrase: "Feet of clay", meaning: "A hidden weakness in someone who is greatly admired.", pic: "🗿🦶", story: "In Daniel's dream, a magnificent statue of gold and silver stood on feet of baked clay — one blow there and the whole idol fell. The taller the hero, the more it matters." },
      ...
      { phrase: "Wash one's hands of", meaning: "To refuse any further responsibility for someone or something.", pic: "🚰🙌", story: "Pilate washed his hands before the crowd to declare the decision was no longer his. The gesture has meant 'not my responsibility' ever since." },
      { phrase: "By the skin of one's teeth", meaning: "By the narrowest possible margin.", pic: "😬📏", story: "From the Book of Job. Teeth have no skin at all — which is precisely the size of the margin you escaped by.", hardWords: [{ word: "margin", meaning: "the amount by which something is won or missed" }] },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "A life of Riley", meaning: "An easy, comfortable and carefree life.", pic: "🛋️🍹", story: "From a music-hall song about a fictional Irishman with nothing to do and everything to enjoy. Nobody knows who Riley was — but everybody wants his schedule." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "A Spartan life", meaning: "A life of simplicity, discipline and self-denial.", pic: "🛡️🥣", story: "Sparta trained its citizens with the barest food, hardest beds and strictest discipline in Greece. Their name became the word for going without on purpose." },
      ...
      { phrase: "Simple living, high thinking", meaning: "A modest way of life combined with lofty ideals.", pic: "🪷📚", story: "Wordsworth's line, and later a favourite of Gandhi's. The two halves are meant to be connected: less spent on the outside, more available on the inside." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "A dog in the manger", meaning: "Someone who stops others using what they cannot use themselves.", pic: "🐕🌾", story: "Aesop's dog settles in the ox's hay manger. It cannot eat hay — it simply growls at the cattle who can. Pure spite with no benefit to itself.", hardWords: [{ word: "manger", meaning: "the box that animal feed is put in" }] },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "It's all Greek to me", meaning: "Completely impossible to understand.", pic: "🇬🇷❓", story: "From a Roman scribes' note — 'it is Greek, it cannot be read'. Shakespeare put it in Julius Caesar and it stuck." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "The lion's share", meaning: "The largest part of something.", pic: "🦁🍰", story: "In Aesop, the lion hunts with other animals and then claims every portion by right of being the lion. Not a fair share — the biggest one." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "Keep one's powder dry", meaning: "To stay prepared for future action while conserving resources.", pic: "🧨☂️", story: "Attributed to Oliver Cromwell: trust in God, and keep your powder dry. Wet gunpowder will not fire, however strong your faith." },
      ...
      { phrase: "A Fabian policy", meaning: "A strategy of achieving success through patience and gradual action.", pic: "🐢🎯", story: "The Roman general Fabius refused to meet Hannibal in open battle, wearing him down instead with delay and small strikes. Mocked as a coward, then proved right." },
      { phrase: "Slow and steady wins the race", meaning: "Patience and persistence lead to success.", pic: "🐢🏁", story: "Aesop's tortoise did not outrun the hare — it simply never stopped while the hare slept." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { phrase: "Pass the buck", meaning: "To shift responsibility to someone else.", pic: "🦌➡️", story: "In frontier poker a buckhorn knife marked whose turn it was to deal; passing it passed the duty. President Truman's desk answered with the famous sign: THE BUCK STOPS HERE." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { phrase: "A Greek gift", meaning: "A gift that brings harm to the person who receives it.", pic: "🎁⚠️", story: "The Trojan horse again — 'beware of Greeks bearing gifts'. Anything given too generously by an enemy is worth inspecting." },
