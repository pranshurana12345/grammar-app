      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-6 pt-5">
          ...
          {filtered.map((idi) => (
            <div key={idi.phrase}
              ...
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
                ...
                <EmojiPic pic={idi.pic} single={28} filter={idi.picFilter} />
              </div>
              <div className="flex-1 min-w-0">
        ...
        <div className="mt-6 px-5 py-4 rounded-2xl bg-amber-50 border border-amber-200">
          ...
          <p className="text-xs text-amber-700 leading-relaxed">
            Want the swipeable reel view? Open the <b>Reels</b> tab from the bottom bar. Use <b>Download PDF</b> to revise this list offline.
          </p>
        </div>
      </div>
    </div>
